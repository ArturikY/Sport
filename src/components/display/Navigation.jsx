...
export const Navigation = () => {
  ...
  return (
    <div className={styles.container}>
      <Link to='/workouts' className={styles.nav}>
        <div>
      ...
      <Link to='/calendar' className={styles.nav}>
        <div>
          <div className={styles.logo}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-calendar2-check" viewBox="0 0 16 16">
