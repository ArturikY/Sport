...
export const Approach = ({
	...
	const deleteApp = approach => {
		deleteEl(listApproaches, approach)
		setListApproaches([...listApproaches])
	}
			...
			<div className={styles.bodyApproach}>
				<div className={styles.parameter}>
					...
					<div className={styles.tuning}>
						<div
							onClick={() => decrement('mainParametr')}
						...
						<div
							onClick={() => increment('mainParametr')}
				...
				<div className={styles.parameter}>
					...
					<div className={styles.tuning}>
						<div onClick={() => decrement('weight')} className={styles.minus}>
							-
						</div>
						<div className={styles.count}>{weight}</div>
						<div onClick={() => increment('weight')} className={styles.plus}>
							+
						</div>
					</div>
				</div>
