	...
	return (
		<div className={styles.container}>
			...
			<div className={styles.description}>
				Approach continue, while you don't choose by you count of repetitions,
			...
			<div className={styles.description}>
				Approach continue, while will run out choose by you time, for example,
				stand of rack for 30 seconds
			</div>
		</div>
	)
}
