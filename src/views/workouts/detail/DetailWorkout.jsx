	...
	return (
		<>
			{!openEdit && !openGo ? (
				<div className={styles.container}>
					<div className={styles.header}>
						<div
							...
							className={`icon-prev ${styles.icon}`}
						/>
					...
					<div className={styles.startWorkout}>
						<div className={styles.iconWorkout}>{detailWorkout.icon}</div>
					...
					<div className={styles.contentWorkout}>
						{detailWorkout.listExercises.map((exercise, index) => (
							<div key={index + 1} className={styles.exercise}>
								<h4>
									Exercise {index + 1} / Approaches:{' '}
									{exercise.listApproaches.length}
								</h4>
				...
				<Go workout={detailWorkout} setOpenGo={setOpenGo} />
			) : null}
		</>
	)
}
